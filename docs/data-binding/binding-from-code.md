...
To do this you can subscribe to [`AvaloniaProperty.Changed`](http://avaloniaui.net/api/Avalonia/AvaloniaProperty/65237C52) which is an observable which fires _every time the property is changed on any instance_.
